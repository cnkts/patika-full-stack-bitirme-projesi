    ...
    <main style={{
      ...
      >
        <section style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
          <img width={"150px"} height={"150px"} src="https://img.freepik.com/premium-vector/car-logo-design-star-car-logo-template_148524-154.jpg?w=740" />
          <h3
            style={{ fontSize: "15px" }}
          >
          ...
          {
            localStorage.getItem("currentUserId") ? <h6 style={{ color: "green" }}>Giriş Başarılı!</h6> : ""
          }
        </section>
        ...
        <section style={{ width: "650px" }}>
          ...
          >
            ...
            <div style={{ marginTop: "10px", width: "500px" }}>
              ...
              Hesabınız yok mu ? <Link style={{ textDecoration: "none" }} to={"/register"}>Kayıt Ol</Link>
            </div>
