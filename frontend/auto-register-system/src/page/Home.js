...
export default function Home() {
  ...
  return (
    <div>
      <main>
        <section style={{ marginLeft: "25px", marginTop: "25px", marginBottom: "50px" }}>
          <h2>ARAÇ KAYIT SİSTEMİ</h2>

        </section>

        <section style={{ marginLeft: "25px", marginTop: "25px" }}>
          <div>
            {localStorage.getItem("token") ? (
              <IconButton onClick={() => logout()} >
                <HiOutlineLogout /> <span style={{ fontSize: "16px", color: "ActiveBorder" }}>Çıkış Yap</span>
              </IconButton>
            ) : (
              ""
            )}
          ...
          <div style={{ background: "white", borderRadius: "15px", width: "400px", marginRight: "25px", marginTop: "25px", float: "right" }}>
              ...
              <div>
                ...
                >
                  <Link to={"/addNewCar"} style={{ textDecoration: "none" }}>
                    ...
                    >
                      <AiOutlinePlus style={{ width: "25px", height: "25px", fontSize: "11px" }} /> <span style={{ fontSize: "14px" }}>Araç Ekle</span>
                    </Button>
                  </Link>

                </section>

                <section style={{ marginLeft: "20px", marginTop: "15px" }}>
                  <IconButton onClick={showModalEdit}><MdFilterAlt /></IconButton>
                  <Button onClick={showModalEdit}> Marka & Modele Göre Filitrele</Button>
                </section>
