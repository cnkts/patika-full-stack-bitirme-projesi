...
export  const validationsRegistered=yup.object().shape({
    name:yup
    .string().min(3,"İsim minimum 3 karakter uzunluğunda olmalıdır")
    ,
    lastName:yup
    .string().min(3,"Soyisim minimum 3 karakter uzunluğunda olmalıdır")
    ,
    userName: yup
    .string()
...
export const validationsAddNewCar=yup.object().shape({
    carName:yup
    .string().min(4,"Araç adı minimum 4 karakter olmalıdır.").required("Bu Alan zorunludur"),
    brand:yup
    ...
    plaka:yup
    .string().min(5,"Plaka minimum 5 karakter olmalıdır").required("Bu Alan zorunludur")
