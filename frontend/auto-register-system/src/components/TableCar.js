...
function TableCar() {
  const columns = useMemo(() => {
    return [
      { id: "carName", label: "Araç Adı", minWidth: 150 },
      { id: "brand", label: "Marka", minWidth: 150 },
      {
        id: "modal",
        label: "Model",
        minWidth: 150,
                    ...
                    >
                      ...
                      <div>
                        {localStorage.getItem("token") ?
                          ...
                          <div>
                            <Link to={`/cardetail/${car.id}`}><IconButton style={{ fontSize: "15px" }}><AiTwotoneEye />Detay</IconButton></Link>
